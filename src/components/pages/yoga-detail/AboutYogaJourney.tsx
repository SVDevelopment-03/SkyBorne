...
const AboutYogaJourney = () => {
  return (
    <div className="max-w-[1268px] w-full mx-auto">
      <div className="grid grid-cols-2 gap-6 sm:gap-12 lg:gap-[142px] items-between">
        <div className="flex flex-col items-start gap-10 min-h-[386px] py-3.5">
          ...
          <Button variant={"theme"} className="max-w-56 mt-auto">
            Sign up & Claim
          </Button>
        </div>
        <div className="flex flex-col gap-2 items-start h-[516px]">
          <Image
