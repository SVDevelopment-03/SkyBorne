      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 lg:gap-[142px] items-between">
        <div className="flex flex-col items-start gap-5 md:gap-10 md:min-h-[386px] md:py-3.5">
          <div className="flex flex-col gap-5 md:gap-10">
            <BannerHeading
              title="What to Expect From Your Zumba Journey"
            ...
            <Typography
              type="theme"
              title="See how Skyborne Zumba brings movement, music, and motivation together. Each class is built to feel like a dance party while still giving you a serious cardio workout"
...
export default AboutZumbaJourney;
