...
export function PackageSelection({ onSelect }: PackageSelectionProps) {
  const [selectedGoldOption, setSelectedGoldOption] = useState<PackageType | null>(null);
  ...
  return (
    <div className="animate-fade-in">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600">Select a membership that fits your wellness goals.</p>
      </div>

      <div className="grid md:grid-cols-3 gap-6 mb-6">
        {/* Gold Package Card with Radio Options */}
        <div className="Package_Card_Default bg-[#fef9f3] rounded-3xl p-8 shadow-sm border border-[#f0e5d8]">
            <div className='min-h-[570px]'>
                <div className="mb-6">
                    ...
                    <h2 className="text-3xl text-gray-800 mb-2">$100 <span className="text-lg text-gray-600">/Month</span></h2>
                    <p className="text-sm text-gray-600 mb-4">Includes: 2 Classes per Month</p>
                </div>
                ...
                <div className="mb-6">
                    ...
                    {goldOptions.map((option) => (
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-800">{option.label} {option.description}</span>
                            </div>
                        </div>
                        </div>
                    ))}
                ...
                <div className="bg-[#fcf6ef] rounded-xl p-4 mb-6 text-sm">
                    ...
                    <p className="text-gray-800">Original Value: <span className="line-through">$120</span> → You Pay <span className="text-[#b97d9f]">$100</span></p>
                </div>
                ...
                <div className="border-t border-[#f0e5d8] pt-4 mb-6">
                    ...
                    className={`overflow-hidden transition-all duration-300 ${
                        goldAccordionOpen ? 'max-h-48 opacity-100 mt-4' : 'max-h-0 opacity-0'
                    }`}
                    >
          ...
          <button
            ...
            className="w-full bg-[#b97d9f] hover:bg-[#a16685] text-white py-3 px-6 rounded-full transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Select Gold Package
          </button>
        </div>
        ...
        <div className="Package_Card_Default bg-[#fef9f3] rounded-3xl p-8 shadow-sm border border-[#f0e5d8]">
            <div className='min-h-[570px]'>
                <div className="mb-6">
                    <div className="inline-block bg-white border border-[#e8d4c0] rounded-full px-5 py-2 mb-4">
                    <span className="text-sm text-gray-700">💎 Diamond Package</span>
                    </div>
                    <h2 className="text-3xl text-gray-800 mb-2">$200 <span className="text-lg text-gray-600">/Month</span></h2>
                ...
                <div className="bg-[#fcf6ef] rounded-xl p-4 mb-6 text-sm">
                    <p className="text-gray-600 mb-1">Discount Applied: 17%</p>
                    <p className="text-gray-800">Original Value: <span className="line-through">$240</span> → You Pay <span className="text-[#b97d9f]">$200</span></p>
                </div>
                ...
                <div className="border-t border-[#f0e5d8] pt-4 mb-6">
                    ...
                    <div
                    className={`overflow-hidden transition-all duration-300 ${
                        diamondAccordionOpen ? 'max-h-64 opacity-100 mt-4' : 'max-h-0 opacity-0'
                    }`}
                    >
                    <table className="w-full text-sm">
                        <thead className="border-b border-[#f0e5d8]">
          ...
          <button
            ...
            className="w-full bg-[#b97d9f] hover:bg-[#a16685] text-white py-3 px-6 rounded-full transition-all duration-300"
          >
        ...
        <div className="Package_Card_Default relative bg-[#b97d9f] rounded-3xl p-8 shadow-lg text-white">
          ...
          <div className='min-h-[570px]'>
                <div className="mb-6 mt-2">
                    ...
                    <h2 className="text-3xl mb-2">$300 <span className="text-lg opacity-90">/Month</span></h2>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-6 text-sm border border-white/20">
                    ...
                    <p>Original Value: <span className="line-through opacity-75">$360</span> → You Pay <span className="font-medium">$300</span></p>
                </div>
                ...
                <div className="border-t border-white/20 pt-4 mb-6">
                    ...
                    <div
                    className={`overflow-hidden transition-all duration-300 ${
                        platinumAccordionOpen ? 'max-h-80 opacity-100 mt-4' : 'max-h-0 opacity-0'
                    }`}
                    >
                    <table className="w-full text-sm">
